  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
      <section className="reveal max-w-2xl">
        ...
        {/* Под заголовком — только приглашение: описание клуба убрано
            (август 2026), про сам клуб рассказывают встречи и книги ниже.
            Вход в /join строкой, а не баннером: второй призыв на экране
            перетягивал внимание. */}
        <p className="mt-4 text-ink-faint">
          Приходи на встречу или{' '}
          <Link to="/join" className="link-inline">
            возьми тему и выступи
          </Link>
          .
        </p>
        <SocialLinks />
